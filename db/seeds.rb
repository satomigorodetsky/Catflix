...
v2 = Video.create!({title:"Felix the Cat, epi1", description:"Felix the Cat was an animated TV show produced by Trans-Lux that first aired in 1959.", year:2002 , video_type:"tv_show", duration:20, views:800})
...
v3 = Video.create!({title:"Felix the Cat, epi2", description:"Felix the Cat was an animated TV show produced by Trans-Lux that first aired in 1959.", year:2002 , video_type:"tv_show", duration:20, views:800})
...
v8 = Video.create!({title:"Keanu", description:"Keanu is a 2016 American buddy action comedy film directed by Peter Atencio and written by Jordan Peele and Alex Rubens. The film stars Peele and Keegan-Michael Key in their first film as lead actors, following five seasons of their sketch TV series.",year:2016 , video_type:"movie", duration:90, views:100})
...
v9 = Video.create!({title:"Kedi", description:"Hundreds of thousands of Turkish cats roam the metropolis of Istanbul freely. This is the story of seven of them.", year:2016 , video_type:"movie", duration:120, views:800})
...
v4 = Video.create!({title:"Garfield: The Movie", description:"Jon Arbuckle buys a second pet, a dog named Odie. However, Odie is then abducted and it is up to Jon's cat, Garfield, to find and rescue the canine.",year:2004 , video_type:"movie", duration:90, views:100})
...
v5 = Video.create!({title:"Garfield: The Show", description:"Everyone's favourite wise-cracking, lasagne-loving feline Garfield is back with best friend Odie.",year:2004 , video_type:"tv_show", duration:90, views:100})
...
v10 = Video.create!({title:"Nine Lives", description:"A stuffy businessman finds himself trapped inside the body of his family's cat.",year:2016 , video_type:"movie", duration:90, views:100})
...
v11 = Video.create!({title:"Oliver & Company", description:"Oliver & Company is a 1988 American animated musical film produced by Walt Disney Feature Animation and released on November 18, 1988, by Walt Disney Pictures.",year:1988 , video_type:"movie", duration:90, views:100})
...
v12 = Video.create!({title:"Tom & Jerry, epi1", description:"Tom and Jerry is an American animated franchise and series of comedy short films created in 1940 by William Hanna and Joseph Barbera.",year:1992 , video_type:"tv_show", duration:90, views:100})
...
v13 = Video.create!({title:"Tom & Jerry, epi2", description:"Tom and Jerry is an American animated franchise and series of comedy short films created in 1940 by William Hanna and Joseph Barbera.",year:1992 , video_type:"tv_show", duration:90, views:100})
...
v14 = Video.create!({title:"Tom & Jerry, epi3", description:"Tom and Jerry is an American animated franchise and series of comedy short films created in 1940 by William Hanna and Joseph Barbera.",year:1992 , video_type:"tv_show", duration:90, views:100})
