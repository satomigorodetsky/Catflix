...
## seeding 
video1 = Video.create!({title:"Cat In The Hat, epi1", genre:"Cartoon", description:"Tom and Jerry is an American animated franchise and series of comedy short films created in 1940 by William Hanna and Joseph Barbera.",year:2018 , video_type:"tv_show", duration:90, views:100})
...
video2 = Video.create!({title:"Tom & Jerry, epi1", genre:"Cartoon", description:"Tom and Jerry is an American animated franchise and series of comedy short films created in 1940 by William Hanna and Joseph Barbera.",year:1992 , video_type:"movie", duration:90, views:100})
video2.url.attach(io: open("https://catflix-new-seed.s3.amazonaws.com/seed2.mp4"), filename: "seed2.mp4" )
video2.thumbnail.attach(io: open("https://catflix-new-seed.s3.amazonaws.com/tom-and-jerry.jpg"), filename: "tom-and-jerry.jpg" )
## seeding 
...
# v15.url.attach(io: open("https://catflix-dev.s3.amazonaws.com/puss_in_boots.mp4"), filename: "puss_in_boots.mp4" )
# v15.thumbnail.attach(io: open("https://catflix-dev.s3.amazonaws.com/puss_in_boots.jpg"), filename: "puss_in_boots.jpg" )
...
# v16.url.attach(io: open("https://catflix-dev.s3.amazonaws.com/pet_semetary.mp4"), filename: "pet_semetary.mp4" )
# v16.thumbnail.attach(io: open("https://catflix-dev.s3.amazonaws.com/pet_semetary.jpg"), filename: "pet_semetary.jpg" )
...
# v17.url.attach(io: open("https://catflix-dev.s3.amazonaws.com/catwoman.mp4"), filename: "catwoman.mp4" )
# v17.thumbnail.attach(io: open("https://catflix-dev.s3.amazonaws.com/catwoman.jpg"), filename: "catwoman.jpg" )

# v18 = Video.create!({title:"Cat In The Hat, epi1", genre:"Cartoon", description:"The Cat in The Hat knows a lot about virtually every thing. With the help of fish, thing 1, and thing 2; the Cat in the Hat teaches kids about many things through song and games.",year:2018 , video_type:"tv_show", duration:90, views:100})
# v18.url.attach(io: open("https://catflix-dev.s3.amazonaws.com/cat_in_the_hat.mp4"), filename: "cat_in_the_hat.mp4" )
# v18.thumbnail.attach(io: open("https://catflix-dev.s3.amazonaws.com/cat_in_the_hat.png"), filename: "cat_in_the_hat.png" )

# v19 = Video.create!({title:"Cat In The Hat, epi2", genre:"Cartoon", description:"The Cat in The Hat knows a lot about virtually every thing. With the help of fish, thing 1, and thing 2; the Cat in the Hat teaches kids about many things through song and games.",year:2018 , video_type:"tv_show", duration:90, views:100})
# v19.url.attach(io: open("https://catflix-dev.s3.amazonaws.com/cat_in_the_hat2.mp4"), filename: "cat_in_the_hat2.mp4" )
# v19.thumbnail.attach(io: open("https://catflix-dev.s3.amazonaws.com/cat_in_the_hat.png"), filename: "cat_in_the_hat.png" )
